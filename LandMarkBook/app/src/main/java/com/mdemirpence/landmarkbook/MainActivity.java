package com.mdemirpence.landmarkbook;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        landmarkNames.add("Eiffrel");
        landmarkNames.add("Empire State");
        ...
        Bitmap empirestate = BitmapFactory.decodeResource(getApplicationContext().getResources(),R.drawable.empirestate);
        ...
        landmarkImages.add(empirestate);
